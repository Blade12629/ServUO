...
namespace Server
{
    public class AssemblyEmitter
    {
		...
		// TODO: in .net 8 the AssemblyBuilder.Save() isn't fully implemented
		// need to do this ourselves
		// See: https://github.com/dotnet/runtimelab/blob/feature/assembly-builder-save/src/Experiment/src/AssemblyBuilder.cs
		// Also see the reference source for AssemblyBuilder in .net framework
		public AssemblyEmitter(string assemblyName, bool canSave)
        {
			...
			m_ModuleBuilder = m_AssemblyBuilder.DefineDynamicModule($"{assemblyName.ToLower()}.dll");
        }
